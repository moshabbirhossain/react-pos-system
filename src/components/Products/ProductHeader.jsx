        ...
        <div className="pHeader-container">
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end">
                    ...
                    <button
                        onClick={() =>
                            document.getElementById("product_list").showModal()
                        }
                        className="btn listButton ml-3 hidden lg:inline-block"
                    >
                    ...
                    <button
                        onClick={() =>
                            document.getElementById("product-show").showModal()
                        }
                        className="btn addButton ml-3 hidden lg:inline-block"
                    >
                        <span className="material-symbols-outlined">add</span>
                    </button>

                    <button
                        className="btn userButton ml-3"
                        onClick={() =>
